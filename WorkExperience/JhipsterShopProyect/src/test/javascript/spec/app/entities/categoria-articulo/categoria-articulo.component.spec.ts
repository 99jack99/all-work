...
import { CategoriaArticuloComponent } from 'app/entities/categoria-articulo/categoria-articulo.component';
...
describe('Component Tests', () => {
  describe('CategoriaArticulo Management Component', () => {
    let comp: CategoriaArticuloComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoriaArticuloComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CategoriaArticulo(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.categoriaArticulos && comp.categoriaArticulos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
